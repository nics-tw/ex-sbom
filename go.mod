...
// goose only needs go-connections v0.7.0 for its testcontainers-based tests
// (never compiled here); v0.7.0 removes sockets.DialPipe and breaks the
// docker client pulled in by the scanning deps, so pin the pre-goose version.
